    ...
    <div className="w-full" style={{ fontFamily: 'Figtree, sans-serif' }}>
      ...
      <div className="relative h-full flex flex-col justify-end px-16 pb-20" style={{ maxWidth: '100%' }}>
        <div style={{ maxWidth: '860px' }}>
          ...
          >
            Once built to connect people through the places they call home, P2P accommodation became a marketplace.
          </h1>
          ...
          >
            Hosts lost their voice. Guests lost the connection. <span style={{ fontWeight: 500 }}>The communities around them started paying the price.</span>
          </p>
        </div>
      </div>
